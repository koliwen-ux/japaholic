...
export const mockCalendarProgress: CalendarProgress[] = [
  // 青森縣
  { id: "cal-aomori-1", prefectureId: "pref-aomori", date: "2026-07-25", task: "確認睡魔祭拍攝許可與採訪證", completed: true },
  { id: "cal-aomori-2", prefectureId: "pref-aomori", date: "2026-08-01", task: "整理弘前城空拍素材並剪輯初稿", completed: false },
  { id: "cal-aomori-3", prefectureId: "pref-aomori", date: "2026-10-10", task: "十和田湖紅葉時程再確認", completed: false },

  // 岩手縣
  { id: "cal-iwate-1", prefectureId: "pref-iwate", date: "2026-06-05", task: "盛岡冷麵店家聯繫與訪談邀約", completed: true },
  { id: "cal-iwate-2", prefectureId: "pref-iwate", date: "2026-09-01", task: "中尊寺金色堂拍攝時段申請", completed: false },
  { id: "cal-iwate-3", prefectureId: "pref-iwate", date: "2026-10-25", task: "龍泉洞地下水路交通確認", completed: false },

  // 宮城縣
  { id: "cal-miyagi-1", prefectureId: "pref-miyagi", date: "2026-05-10", task: "仙台牛舌名店排班確認", completed: true },
  { id: "cal-miyagi-2", prefectureId: "pref-miyagi", date: "2026-07-20", task: "松島遊覽船船班與空拍申請", completed: true },
  { id: "cal-miyagi-3", prefectureId: "pref-miyagi", date: "2026-08-01", task: "七夕祭布置進度追蹤", completed: false },

  // 秋田縣
  { id: "cal-akita-1", prefectureId: "pref-akita", date: "2026-03-10", task: "乳頭溫泉鄉住宿與湯屋預約", completed: true },
  { id: "cal-akita-2", prefectureId: "pref-akita", date: "2026-04-15", task: "角館武家屋敷開放時間確認", completed: false },
  { id: "cal-akita-3", prefectureId: "pref-akita", date: "2026-12-01", task: "男鹿半島生剝鬼直播設備測試", completed: false },

  // 山形縣
  { id: "cal-yamagata-1", prefectureId: "pref-yamagata", date: "2026-01-05", task: "藏王樹冰纜車班次與天候確認", completed: true },
  { id: "cal-yamagata-2", prefectureId: "pref-yamagata", date: "2026-02-01", task: "銀山溫泉夜景拍攝點勘景", completed: true },
  { id: "cal-yamagata-3", prefectureId: "pref-yamagata", date: "2026-06-20", task: "櫻桃園採果採訪邀約", completed: false },

  // 福島縣
  { id: "cal-fukushima-1", prefectureId: "pref-fukushima", date: "2026-03-20", task: "鶴城賞櫻花期預測與行程排定", completed: true },
  { id: "cal-fukushima-2", prefectureId: "pref-fukushima", date: "2026-01-20", task: "大內宿雪景交通與路況確認", completed: true },
  { id: "cal-fukushima-3", prefectureId: "pref-fukushima", date: "2026-07-15", task: "桃子甜點店家菜單與拍攝許可", completed: false },

  // 新潟縣
  { id: "cal-niigata-1", prefectureId: "pref-niigata", date: "2026-05-15", task: "佐渡島渡輪船班與空拍申請", completed: true },
  { id: "cal-niigata-2", prefectureId: "pref-niigata", date: "2026-09-01", task: "越光米農家採訪邀約與拍攝許可", completed: false },
  { id: "cal-niigata-3", prefectureId: "pref-niigata", date: "2026-11-01", task: "古町藝妓文化採訪窗口確認", completed: false },
];
...
/**
 * Sample 6-day itinerary touring all six Tohoku prefectures.
 * `title` is still read at runtime (`tripTitle` in ItineraryPlanner); `stops`
 * is seed-only — the app reads stops from Supabase, see the note on
 * `mockContentItems` above.
 */
export const mockItineraries: Itinerary[] = [
  {
    id: "itin-tohoku-6days",
    title: "東北六縣夏季取材踩點行程",
    stops: [
      {
        id: "stop-1-fukushima",
...
/**
 * Pre-production content proposals, transcribed from the trip's planning deck
 * (2026_08_福島夏日漫旅.pptx). All currently anchored to 福島縣 — the only
 * prefecture with a prep deck so far.
 * Seed-only: see the note on `mockContentItems` above.
 */
export const mockContentProposals: ContentProposal[] = [
  {
...
/**
 * Trip budget line items, transcribed from the planning deck's 預算規劃 slide (two-person trip).
 * Seed-only: see the note on `mockContentItems` above.
 */
export const mockBudgetItems: BudgetItem[] = [
  { id: "budget-lodging", category: "四晚住宿", amount: 14000, note: "會津若松站附近商務旅館＋一晚溫泉旅館，雙人房" },
  { id: "budget-transport", category: "機場及當地交通", amount: 7000, note: "JR、巴士、只見線及少量計程車備用" },
  { id: "budget-food", category: "五天餐飲", amount: 11000, note: "因需產出美食文章，建議多抓甜點、咖啡及多道料理" },
  { id: "budget-tickets", category: "景點門票", amount: 1200, note: "鶴城、展館等；五色沼、大內宿多數區域免費" },
  { id: "budget-connectivity", category: "網路及旅遊保險", amount: 2000, note: "兩人 eSIM＋基本旅平險" },
  { id: "budget-shooting", category: "拍攝額外支出", amount: 3000, note: "寄物櫃、飲品、補拍餐點" },
  { id: "budget-contingency", category: "緊急備用金", amount: 4000, note: "錯過班次、臨時叫車或天候調整" },
];
